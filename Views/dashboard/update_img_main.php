<div class="content-wrapper" style="min-height: 22px;">
  <div class="content pt-2">
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12">
          <form method="POST" action="<?= BASE_URL ?>dashboard/img_upload_carousel_action/<?= $_GET['id']?>" enctype="multipart/form-data">
                  ...
                  <div class="card card-default">
                    ...
                    <div class="card-body">
                      <div class="form-group">
                        <div class="col-lg-6">
                          <div class="form-group">
                          <img id="blah" alt="your image" src="<?= BASE_URL ?>media/upload/images/<?= $id_post['image']?>" width="250" height="150" /><br>
