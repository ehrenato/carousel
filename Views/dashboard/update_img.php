<div class="content-wrapper" style="min-height: 22px;">
  <div class="content pt-2">
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12">
          <form method="POST" action="<?= BASE_URL?>dashboard/noticia_update_action">
                ...
                <div class="col-md-12">
                  <div class="card card-default">
                    <div class="card-header">
                      <a href="<?= BASE_URL; ?>dashboard/img_upload_carousel_form?id=<?= $_GET['id']?>" role="button" class="btn btn-primary btn-sm float-right">
                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <span id="msg_subtitulo" style="color:red;"></span>
                      </div>
                      <div class="form-group">
                        <label for="corpo">Descrição</label>
                        <textarea name="corpo" id="corpo"><?= $info_post['post']?></textarea>
                      </div>
                      <div class="col-12">
