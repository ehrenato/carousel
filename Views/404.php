...
<body class="text-center">
  <nav role="navigation" class="text-center mt-3">
    <div class="navbar-header d-inline-block float-none">
      <img class="logo-suinin" src="<?= BASE_URL ?>assets\imagens\icons\logo-gtrigueiro.png">

      <img class="logo-suinin" src="<?= BASE_URL ?>assets\imagens\icons\logo-suinin.png">
    </div>
  </nav>
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <div class="error-template">
          <h1>
            :) Oops!</h1>
          <h2>
            Estamos em manutenção</h2>
          <h1>
            para melhor atendê-los!</h1>
          <div>
            <p>
              Desculpe-nos pelo incoveniente, mas estamos realizando uma manutenção no sistema no momento. Voltaremos em breve!</p>
            <p>
              — GTI - SESAP</p>
          </div>
          <div class="error-actions">
            <a href="http://gti.saude.rn.gov.br/site" style="margin-top: 10px;" class="btn btn-info btn-lg">Acesse nosso portal</a>
          </div>
        </div>
      </div>
      <div class="col-md-6 polygons">
