        ...
        <div class="col-12 col-md-12">
          <div class="card">
            <div class="card-header">
              Todas as Notícias
              <a href="<?= BASE_URL ?>carrossel/noticia_form" role="button" class="btn btn-primary btn-sm float-right">
                    ...
                    <?php foreach ($total as $t) : ?>
                      <?php if ($t['fixo'] == 0) : ?>
                        <tr>
                          ...
                          <td>
                            <a href="<?= BASE_URL ?>carrossel/noticia_update_form?id=<?= $t['id'] ?>" class="text-none">
